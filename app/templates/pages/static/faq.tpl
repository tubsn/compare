...
<p>Wir nutzen in Compare eine Vielzahl von Datenquellen für unterschiedliche KPI Daten, die wir meist exklusiv aus diesen Datenquelle beziehen können. Aktuell sind das Kilkaya und Google Analytics. Klickzahlen/Pageviews sind in beiden Quellen vorhanden und weichen Teilweise stark voneinander ab. Bei Kilkaya werden die Pageviews weitgehend ungefiltert erfasst. Hier wirkt sich unter anderem sogenannter Bot-Traffic (also maschinelle Abrufe der Webseite z.B. durch Suchmaschinen Crawler, Hackerangriffe usw.) auf die Klickzahlen aus. Google Analytics filtert diesen durch verschiedene Mechanismen heraus, um ein möglichst realistisches Bild abzugeben. In naher Zukunft können wir über unser neues Datawarehouse "Luna", eigens verwaltete Zähl- und Filterverfahren nutzen. Um möglicherweise ein klareres Bild zu schaffen</p>
