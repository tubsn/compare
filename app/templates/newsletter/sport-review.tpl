...
<?php if (PORTAL == 'LR'): ?>
<p>das ist der Überblick über unsere aktuellsten Texte der letzten 7 Tage. Alles über 2000 Klicks oder mindestens zwei Conversions können wir als tollen Erfolg verbuchen.
...
<?php else: ?>
<p>das ist der Überblick über unsere aktuellsten Texte der letzten 7 Tage. Alles über 1000 Klicks oder mindestens zwei Conversions können wir als tollen Erfolg verbuchen.
Bei allen anderen Texten unterhalb dieser Richtwerte müssen wir uns ehrlich die Frage beantworten: Lohnt es sich, weiter dieses Thema anzufassen?</p>
<?php endif ?>
...
<?php else: ?>
<p>Alle Texte, die unter 300 Klicks einlaufen, gelten als Misserfolg und stehen ab sofort unter Beobachtung – dort haben wir offenbar keine Audience, für die sich der Einsatz unserer Arbeitskraft lohnt.</p>
<?php endif ?>
