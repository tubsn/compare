...
<p>
<a class="button" href="javascript:(function(){let artID = parseInt(location.pathname.substr(-13, 8)); if (location.hostname.indexOf('lr-online') >= 0 && artID) {
...
<a href="javascript:(function(){let artID = parseInt(location.pathname.substr(-13, 8)); if (location.hostname.indexOf('lr-online') >= 0 && artID) {
